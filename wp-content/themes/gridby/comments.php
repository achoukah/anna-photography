...
if ( post_password_required() ) { ?>
    <p class="nocomments"><?php _e('This post is password protected. Enter the password to view comments.', 'gridby'); ?></p>
<?php
    return; }
...
if ( have_comments() ) : ?>
    <h3 id="comments"><?php comments_number( __( 'No Responses', 'gridby' ), __( '1 Response', 'gridby' ), __( '% Responses', 'gridby') ); ?></h3>
    ...
    if ( ! comments_open() ) : // There are comments but comments are now closed ?>
    	<p class="nocomments"><?php _e('Comments are closed.', 'gridby'); ?></p>
    <?php    
    endif;
